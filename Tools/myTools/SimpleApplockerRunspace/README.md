...
```
> [!NOTE]
> If you are comiling from Visual Studio Code, use _Console Application (.NET Framework)_ for _C#_ and add the following reference: `Right-click on References in the Solution Explorer > Add Reference > Search for "System.Configuration.Install"`
