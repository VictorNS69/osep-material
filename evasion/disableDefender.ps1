...
powershell Set-MpPreference -DisableIntrusionPreventionSystem 1 -DisableIOAVProtection 1 -DisableRealtimeMonitoring 1 -DisableScriptScanning 1 -EnableControlledFolderAccess Disabled -EnableNetworkProtection AuditMode -Force -MAPSReporting Disabled -SubmitSamplesConsent NeverSend
